...
{{
var G__10241 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10241;
continue;
}
} else
...
{var pred__10245 = cljs.core._EQ_;var expr__10246 = limit;if(cljs.core.truth_(pred__10245.call(null,(1),expr__10246)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10245.call(null,(2),expr__10246)))
...
var G__10248 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10249 = (limit__$1 - (1));
var G__10250 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__10248;
limit__$1 = G__10249;
parts = G__10250;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10252 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10252))
{var replacement_10253 = temp__4124__auto___10252;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10253)));
} else
{buffer.append(ch);
}
{
var G__10254 = (index + (1));
index = G__10254;
continue;
}
}
