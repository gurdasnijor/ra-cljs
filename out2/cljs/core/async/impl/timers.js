...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_12954 = (0);while(true){
if((i_12954 < arr.length))
{(arr[i_12954] = null);
{
...
{var i_12961 = (self__.level + (1));while(true){
if((i_12961 <= (new_level + (1))))
{(update[i_12961] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12963 = (0);while(true){
if((i_12963 <= self__.level))
{var links_12964 = (update[i_12963]).forward;if(((links_12964[i_12963]) === x__$1))
{(links_12964[i_12963] = (x__$1.forward[i_12963]));
{
var G__12965 = (i_12963 + (1));
i_12963 = G__12965;
continue;
}
} else
{{
var G__12966 = (i_12963 + (1));
i_12963 = G__12966;
continue;
}
}
